\documentclass[a4paper]{article}
    ...
    \usepackage[top=2.5cm, bottom=0cm, left=2cm, right=1.5cm]{geometry}
...
\begin{center}
	...
	Brisbane QLD, Australia $\cdot$ nick@ndl.im $\cdot$ +61 407 980 730 $\cdot$ \href{https://ndl.im}{ndl.im}\\
\end{center}
...
\begin {degrees}
Bachelor of Engineering (Hons) (Software Engineering) \hfill Feb 2016 - Dec 2019\\
...
\begin{myitemize} \itemsep 0.75mm
	...
	\item Developed and maintained a real-time online resource monitoring portal for the LED network.
	\item Compiled and provided financial reports for investors and industry bodies.
...
\textbf{{ELAN Language Resource Creator} (\href{https://github.com/nicklambourne/elan2resource}{https://github.com/nicklambourne/elan2resource})}
\begin{singleitem}
	\item As part of the UQ Winter Research Scholarship I developed a cross-platform Python application, using the Qt GUI library, for creating language resources from ELAN linguistic analysis files and associated media files.
\end{singleitem}
