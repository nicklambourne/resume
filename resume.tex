...
\textbf{Canva Pty. Ltd.} \hfill Sydney, NSW\\
\textit{Software Engineering (Back-End) Intern} \hfill Dec 2019 - Present\\
\begin{myitemize} \itemsep 0.5mm
	\item Attached to the infrastructure team, working on transpilation and static analysis based projects in bash and Python.
\end{myitemize}
